    ...
    private static FileBasedInputOuter CreateConfig(IStrykerInputs inputs)
    {
        return new FileBasedInputOuter
        {
            Input = new FileBasedInput
            {
                ...
                UnityMemoryConsumptionLimitInMb = inputs.UnityMemoryConsumptionLimitInMbInput.SuppliedInput,
                PathToUnity = inputs.PathToUnityInput.SuppliedInput ?? inputs.PathToUnityInput.Default,
                UnityTestMode = inputs.UnityTestModeInput.SuppliedInput,
